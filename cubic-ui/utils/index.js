...
const addResize = resizeEvent.addResizeListener,
 ...
 * 计算当前屏幕的宽度
 */
 function caculateViewable() {
  let node = document.querySelector('.app-container__main__content') || document.querySelector('.app-container-home')
  const bounding = node.getBoundingClientRect()
  return {
    left: (bounding.x || bounding.left), // 兼容性问题， x|left属性,
